    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invitation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rsvp.Invitation', unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Roommate',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cost_estimate', models.IntegerField(blank=True, help_text="How much do you estimate air and ground transportation will cost? Don't include lodging and meals. (Just numbers, no dollar signs or symbols.)", max_length=140, null=True)),
        ...
        migrations.AddField(
            model_name='ignite',
            name='invitation',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rsvp.Invitation', unique=True),
        ),
